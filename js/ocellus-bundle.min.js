...
"use strict";"undefined"!=typeof O&&"object"==typeof O||(O={});
"use strict";"undefined"!=typeof O&&"object"==typeof O||(O={}),O.niceNumbers=function(e){return e>9?e:["No","One","Two","Three","Four","Five","Six","Seven","Eight","Nine"][e]},O.renderResults=function(e){const t=e.resource,r=e.template,n=document.querySelector(`#${t} div.result`),s=document.querySelector(`#template-${r}`).innerHTML,o={"template-pager":document.querySelector("#template-pager").innerHTML,"template-records-found":document.querySelector("#template-records-found").innerHTML,"template-kein-preview":document.querySelector("#template-kein-preview").innerHTML};n.innerHTML=Mustache.render(s,e,o);const i=document.querySelectorAll("figcaption > a");for(let e=0,t=i.length;e<t;e++)i[e].addEventListener("click",O.toggleFigcaption);return e.resource},O.getResource=function(e){e&&(e.stopPropagation(),e.preventDefault());const t=document.querySelector("#searcher"),r=t.elements,n=t.querySelector("input[name=q]");if(""===n.value)return n.placeholder="c‘mon, enter something",n.classList.remove("nudge"),n.classList.add("warning"),n.focus(),!1;n.classList.remove("warning"),n.classList.add("nudge");const s={};for(let e=0,n=r.length;e<n;e++){const r=t[e];if(r.name){const e=r.name,t=r.value,n=r.type,o=r.checked;"checkbox"===n?o&&(e in s?s[e].push(t):s[e]=[t]):"radio"===n?o&&(s[e]=t):s[e]=t}}O.getFoo({resource:document.querySelector("input[name=resource]:checked").value,inputs:s,cb:O.renderResults})},O.noThrob=function(e){const t=document.querySelectorAll("main section");for(let r=0,n=t.length;r<n;r++){const n=t[r].id;n!==e&&O.hide(n)}document.querySelector("#throbber").classList.add("nothrob")},O.getFoo=function(e){const{resource:t,inputs:r,cb:n}=e,{z:s,b:o}=O.inputs2uris(r,t);let i;O.logger("getFoo()",`getting ${t}`),log.info(`zenodeoUri: ${s}`),log.info(`browserUri: ${o}`),document.querySelector("#throbber").classList.remove("nothrob"),r&&(i=r?O.formatSearchCriteria(r):"",O.waitMessage(t,i),history.pushState(null,null,o),O.show(t));fetch(s).then(O.fetchReceive).then((function(e){const n=e["num-of-records"],s={resource:t,"num-of-records":n};if(r){const c=30;s.successful=!0,s["search-criteria-text"]=i,32===r.q.length?("treatments"===e["search-criteria"].resource?s.template="treatment":"citations"===e["search-criteria"].resource&&(s.template="citation"),n&&(s.figures=e.records[0])):(s.template=s.resource,n?(s.shown=1==n?"it is shown below":n>1&&n<=c?`${O.niceNumbers(e.from)} to ${O.niceNumbers(n)} are shown below`:`${O.niceNumbers(e.from)} to ${O.niceNumbers(e.to)} are shown below`,s.figures=function(e,t){let r=[];if("treatments"===e)for(let e=0,n=t.length;e<n;e++){const n=t[e];n.recId=n.treatmentId,r.push(n)}else if("images"===e)for(let e=0,n=t.length;e<n;e++){const n=t[e];r.push({title:n.metadata.title,creators:n.metadata.creators?n.metadata.creators.map(e=>e.name):[],recId:n.id,zenodoRecord:O.zenodoUri+n.id,description:n.metadata.description,doi:n.doi,img:!!n.links.thumbs,img10:n.links.thumbs?n.links.thumbs[10]:"",img50:n.links.thumbs?n.links.thumbs[50]:"",img100:n.links.thumbs?n.links.thumbs[100]:"",img250:n.links.thumbs?n.links.thumbs[250]:"",img750:n.links.thumbs?n.links.thumbs[750]:"",img1200:n.links.thumbs?n.links.thumbs[1200]:""})}else if("citations"===e)for(let e=0,n=t.length;e<n;e++){const n=t[e];n.recId=n.bibRefCitationId,r.push(n)}return r}(t,e.records),s.niceNumbers=O.niceNumbers(n),n>=c&&(s.prev=o.replace(/page=\d+/,`page=${e.prevpage}`),s.next=o.replace(/page=\d+/,`page=${e.nextpage}`),s.pager=!0)):(s.pager=!1,s.figures=[]))}return s})).then(n).then(O.noThrob)},O.waitMessage=function(e,t){const r=document.querySelector(`#${e}`);O.show(e),r.querySelector(".result").innerHTML=`<p id="records-found" class="records-found">Looking for ${e} where ${t}</p>`},O.inputs2uris=function(e,t){const r={images:["q","size","page","communities","refreshCache"],treatments:["q","size","page","refreshCache"],citations:["q","size","page","refreshCache"]},n={images:["q","size","page","communities"],treatments:["q","size","page"],citations:["q","size","page"]},s=[],o=[];for(const i in e)r[t].includes(i)&&("q"===i?32==i.length?"treaments"===t?s.push(`treatmentId=${e[i]}`):"citations"===t&&s.push(`bibRefCitationId=${e[i]}`):s.push(`q=${e[i]}`):s.push(`${i}=${e[i]}`)),n[t].includes(i)&&o.push(`${i}=${e[i]}`);const i=s.length?`?${s.sort().join("&")}`:"";return{z:`${O.zenodeoUri}/${t}${i}`,b:`${t}.html${o.length?`?${o.join("&")}`:""}`}};