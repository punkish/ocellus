...
async function getCollectionCodes() {
    return await getDataFromZenodeo({
        url: `${window.Ocellus.uris.zenodeo}/collectioncodes?cols=collectionCode&cols=name&size=4300`,
...
async function getJournalTitles() {
    return await getDataFromZenodeo({
        url: `${window.Ocellus.uris.zenodeo}/journals?size=1100&sortby=journalTitle:asc`,
        segment: 'journals',
